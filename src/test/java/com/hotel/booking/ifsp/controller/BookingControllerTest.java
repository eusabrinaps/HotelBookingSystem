...
class BookingControllerTest extends ApiIntegrationTestBase {
    ...
    @Tag("ApiTest")
    @Tag("IntegrationTest")
    @DisplayName("PATCH /bookings/{id}/cancel without token returns 401")
    void shouldReturn401WhenCancellingBookingWithoutToken() {
        UUID bookingId = createBooking(
                RoomCategory.STANDARD,
                LocalDate.now().plusDays(10),
                LocalDate.now().plusDays(12),
    ...
    @Tag("ApiTest")
    @Tag("IntegrationTest")
    @DisplayName("PATCH /bookings/{id}/checkin without token returns 401")
    void shouldReturn401WhenCheckingInBookingWithoutToken() {
        UUID bookingId = createBooking(
                RoomCategory.STANDARD,
                LocalDate.now().minusDays(1),
                LocalDate.now().plusDays(2),
    ...
    @Tag("ApiTest")
    @Tag("IntegrationTest")
    @DisplayName("PATCH /bookings/{id}/checkout without token returns 401")
    void shouldReturn401WhenCheckingOutBookingWithoutToken() {
        UUID bookingId = createBooking(
                RoomCategory.STANDARD,
                LocalDate.now().minusDays(1),
                LocalDate.now().plusDays(2),
    ...
    @Tag("ApiTest")
    @Tag("IntegrationTest")
    @DisplayName("PUT /bookings with invalid room category returns 400")
    void shouldReturn400WhenUpdatingBookingWithInvalidRoomCategory() {
    ...
    @Tag("ApiTest")
    @Tag("IntegrationTest")
    @DisplayName("PATCH /bookings/{id}/cancel on already cancelled booking returns 400")
    void shouldReturn4xxWhenCancellingAlreadyCancelledBooking() {
        UUID bookingId = createBooking(
                RoomCategory.STANDARD,
                LocalDate.now().plusDays(10),
                LocalDate.now().plusDays(12),
    ...
    @Tag("ApiTest")
    @Tag("IntegrationTest")
    @DisplayName("PATCH /bookings/{id}/cancel on completed booking returns 400")
    void shouldReturn4xxWhenCancellingCompletedBooking() {
        UUID bookingId = createBooking(
                RoomCategory.STANDARD,
                LocalDate.now().plusDays(10),
                LocalDate.now().plusDays(12),
    ...
    @Tag("ApiTest")
    @Tag("IntegrationTest")
    @DisplayName("PATCH /bookings/{id}/checkin before check-in date returns 400")
    void shouldReturn4xxWhenCheckingInBeforeScheduledDate() {
        UUID bookingId = createBooking(
                RoomCategory.STANDARD,
